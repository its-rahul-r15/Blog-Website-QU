...
const Newslatter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <form className='flex items-center justify-between md:h-13 w-full h-12 max-w-2xl'>
            ...
            <button type='submit' className='md:px-12 px-8 h-full text-white bg-primary/80 hover:bg-primary transition-all cursor-pointer ounded-md rounded-1-none'>Subscribe</button>
        </form>
    </div>
  )
}

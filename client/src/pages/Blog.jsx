  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Rahul Sharma</p>
      </div>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'>
            ...
            <div className='flex flex-col gap-4'>
                {Comments.map((item,index)=>(
                  <div key={index} className='relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded teext-gray-600'>
